...
/** @type {string} */
const CACHE_VERSION = '1775048614|36687665';
/** @type {string} */
const CACHE_PREFIX = 'Dungeon master l-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Dungeon master lite.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Dungeon master lite.html","Dungeon master lite.js","Dungeon master lite.offline.html","Dungeon master lite.icon.png","Dungeon master lite.apple-touch-icon.png","Dungeon master lite.audio.worklet.js","Dungeon master lite.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Dungeon master lite.wasm","Dungeon master lite.pck","Dungeon master lite.side.wasm"];
